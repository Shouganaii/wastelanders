...
class Users extends Model
{
    ...
    public function editInfo($id, $data)
    {
        if ($id === $this->getId()) {
            ...
            return 'Não é permitido editar outros usuários!';
        }
    }
    ...
    public function delete($id)
    {
        if ($id === $this->getId()) {
            $photos = new Photos();
            $photos->deleteAll($id);
            $sql = "DELETE FROM users_following WHERE id_user_active = :id_user or id_user_passive = :id_user";
            $sql = $this->db->prepare($sql);
            ...
            return 'Não é permitido excluir outros usuários';
        }
    }
